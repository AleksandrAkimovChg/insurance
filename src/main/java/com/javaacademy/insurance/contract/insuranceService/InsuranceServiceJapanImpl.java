...
@Component
@Slf4j
public class InsuranceServiceJapanImpl implements InsuranceService {
    InsuranceCalcService calcService;
    @Value("${japan.currency}")
    Currency currency;
    @Value("${japan.country}")
    Country country;

    public InsuranceServiceJapanImpl(@Qualifier("insuranceCalcJapanServiceImpl") InsuranceCalcService calcService) {
